...
fig.update_layout(yaxis_title='Frecuencia', title='Geología Estructural', autosize=True, height=700, width = 1900, font=dict(family="bold, monospace", size=14, color="black"))
