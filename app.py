...
fig = px.bar(df, x="Competencia", y=["Elemental", "Básico", "Intermedio", "Avanzado", "Especializado"], barmode='group', labels=dict(variable="Nivel de dominio", value = "Frecuencia"), color_discrete_sequence=["#8C564B", "rgb(127, 60, 141)", "rgb(36, 121, 108)", "blue", "rgb(255, 237, 111)"], height=400, width = 1900) #400 900
# st.dataframe(df) # if need to display dataframe



fig.update_layout(yaxis_title='Frecuencia', title='Competencias vs Frecuencia', autosize=True, height=700, width = 1900, font=dict(family="bold, monospace", size=14, color="black"))
